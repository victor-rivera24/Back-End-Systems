					...
					<body>
						...
						<div class="container">
								...
								<div class="card" style="text-align:center">
									...
									<div class="card-body" >
										<div>
											<p>La orden <strong>'. $_orden .'</strong>. Se canceló debidó a la falta de pago.<p>		
										</div>
										<div>
											<p>El Traspaso Entre Sucursales <strong>'. $_orden .'</strong>.  Se canceló debidó a la falta de pago de la orden<p>		
										</div>
									</div>
